/**
 * Creates the basic layout of the server gui. Works through Eclipse. have not tried on the pi yet.
 * 
 * Print statments everytime a button is pressed
 *
...
private int t1 = 0;
private int t2 = 0;
int x = 0;    //setup number of connected clients
